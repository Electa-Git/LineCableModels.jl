@testitem "BaseParams: calc_tubular_resistance unit tests" setup = [defaults] begin
	...
	@testset "Basic Functionality" begin
		...
		Top = 25.0
		expected =
			calc_temperature_correction(alpha, Top, T0) * rho / (π * (r_ex^2 - r_in^2))
	...
	@testset "Edge Cases" begin
		...
		expected4 =
			calc_temperature_correction(-0.001, Top, T0) * rho / (π * (0.02^2 - 0.01^2))
	...
	@testset "Numerical Consistency" begin
		...
		expectedf =
			calc_temperature_correction(Float32(0.00393), Float32(25.0), Float32(20.0)) *
