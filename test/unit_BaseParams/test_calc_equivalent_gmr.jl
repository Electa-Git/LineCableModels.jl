@testitem "BaseParams: calc_equivalent_gmr unit tests" setup =
	...
	@testset "Numerical Consistency" begin
		...
		material_props = Material(1.7241e-8, 1.0, 0.999994, 20.0, 0.00393)
		part1f32 =
			CircStrands(Float32(0.01), Float32(0.002), 7, Float32(10), material_props)
		part2f32 =
			CircStrands(Float32(0.02), Float32(0.002), 7, Float32(15), material_props)
