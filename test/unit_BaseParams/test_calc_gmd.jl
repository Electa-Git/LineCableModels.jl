@testitem "BaseParams: calc_gmd unit tests" setup =
	[defaults, deps_datamodel, defs_materials] begin
	@testset "Basic Functionality" begin
		material_props = Material(1.7241e-8, 1.0, 0.999994, 20.0, 0.00393)
		circ_strands =
			CircStrands(0.01, Diameter(0.002), 7, 10, material_props, temperature = 25)
	...
	@testset "Numerical Consistency" begin
		...
		tubular_f32 =
			Tubular(Float32(0.01), Float32(0.02), material_props, temperature = 25)
