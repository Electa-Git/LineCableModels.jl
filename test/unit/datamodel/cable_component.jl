@testitem "DataModel / CableComponent / unit tests" tags=[:unit] setup=[
    ...
    # --- Reference materials (fallbacks if `TestFixtures, MaterialFixtures` lacks a key) ---
    ...
    make_conductor_group_F=function ()
        ...
        # add helical wire layer (DataModelTestSupport, UseDataModelSupport, TestNumerics: r_in = group.r_ex)
    ...
    @testset "Physical Behavior" begin
        ...
        @test isapprox(cc.conductor_props.alpha, gC.alpha; atol = TestNumerics.absolute_floor(Float64))
