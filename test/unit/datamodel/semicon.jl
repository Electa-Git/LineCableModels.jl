@testitem "DataModel / Semicon / constructor unit tests" tags=[:unit] setup=[
    ...
    @testset "Input Validation" begin
        ...
        @test_throws ArgumentError Semicon(r_in = 0.01)
        @test_throws ArgumentError Semicon(r_in = 0.01, r_ex = 0.012)
    ...
    @testset "Basic Functionality" begin
        ...
        @test s.cross_section ≈ π * (0.012^2 - 0.01^2) atol = TestNumerics.absolute_floor(Float64)
        # Measurement type
        s2 = Semicon(
