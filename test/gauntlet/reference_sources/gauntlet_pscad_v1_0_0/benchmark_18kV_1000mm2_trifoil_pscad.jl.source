@testitem "PSCAD benchmark / 18 kV 1000 mm² trifoil" tags=[:gauntlet] setup=[GauntletSupport] begin
    using Test
    using DataFrames
    ...
    core_strand_diameter=4.19e-3
    screen_wires=49
    screen_wire_diameter=0.94e-3
    ...
    pe_face_thickness=0.05e-3
    jacket_thickness=3.4e-3
    ...
    jacket_parts=(
        ...
        Insulator.Tubular(:jacket; thickness = pe_face_thickness, material = pe),
    ...
    reference_formulation=Formulation(
        ...
        options = PSCADOptions(output_stem = "18kV_1000_trif")
    )
