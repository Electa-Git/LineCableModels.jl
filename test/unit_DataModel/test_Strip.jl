@testitem "DataModel(Strip): constructor unit tests" setup =
	[defaults, deps_datamodel, defs_materials] begin
	...
	@testset "Basic Functionality" begin
		...
		@test s isa Strip
		@test s.r_in ≈ 0.01 atol = TEST_TOL
		@test s.r_ex ≈ 0.012 atol = TEST_TOL
		...
		@test s2 isa Strip
		@test value(s2.r_in) ≈ 0.01 atol = TEST_TOL
		@test value(s2.r_ex) ≈ 0.012 atol = TEST_TOL
	...
	@testset "Edge Cases" begin
		...
		@test s.r_in ≈ 1e-6 atol = TEST_TOL
		# width very small
