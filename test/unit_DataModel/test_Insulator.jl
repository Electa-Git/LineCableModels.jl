@testitem "DataModel(Insulator): constructor unit tests" setup =
	...
	@testset "Basic Functionality" begin
		...
		@test i.r_in ≈ 0.01 atol = TEST_TOL
		@test i.r_ex ≈ 0.015 atol = TEST_TOL
		...
		@test value(i2.r_in) ≈ 0.01 atol = TEST_TOL
		@test value(i2.r_ex) ≈ 0.015 atol = TEST_TOL
	...
	@testset "Edge Cases" begin
		...
		@test i.r_in ≈ 1e-6 atol = TEST_TOL
	end
	...
	@testset "Type Stability & Promotion" begin
		...
		iMix1 =
			Insulator(measurement(0.01, 1e-5), 0.015, insulator_props, temperature = 20.0)
		@test typeof(iMix1.r_in) <: Measurement
		# Mixed: temperature as Measurement
		iMix2 =
			Insulator(0.01, 0.015, insulator_props, temperature = measurement(20.0, 0.1))
