...
@testitem "DataModel(LineCableSystem): constructor & add! unit tests" setup =
	[defaults, defs_linesys] begin
...
@testitem "DataModel(LineCableSystem): promotion safety (intern-proof)" setup =
	[defaults, defs_linesys] begin
	using Test
	using Measurements
