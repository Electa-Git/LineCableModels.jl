@testitem "Public modeling API and explicit materialized boundary" setup = [defaults] begin
...
@testitem "public Material populates MaterialsLibrary" setup = [defaults] begin
...
@testitem "CableBuilder stages numeric radius and thickness declarations" setup = [defaults] begin
    import LineCableModels.ParametricBuilder as PB
...
@testitem "compute! owns ordinary, parametric, and conditional Monte Carlo execution" setup = [defaults] begin
    using Random
    using Distributions
    import LineCableModels.ParametricBuilder as PB
...
@testitem "one Formulation evaluates materialized and Gridspace line problems" setup = [defaults] begin
    import LineCableModels.ParametricBuilder as PB
...
@testitem "invalid configuration handling is strict and auditable" setup = [defaults] begin
    import LineCableModels.ParametricBuilder as PB
...
@testitem "DataFrame rendering never computes cable constants" setup = [defaults] begin
    import LineCableModels.ParametricBuilder as PB
