function build_case(::Val{:cable_320kv_no_armour_dc_bipole}, p)
...
case_definition(Base.Fix1(build_case, Val(:cable_320kv_no_armour_dc_bipole)),
    ...
    description = "320 kV unarmoured cable DC bipole"
)
