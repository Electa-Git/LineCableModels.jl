function build_case(::Val{:cable_525kv_1600mm2_bipole}, p)
...
case_definition(Base.Fix1(build_case, Val(:cable_525kv_1600mm2_bipole)),
    ...
    description = "525 kV 1600 mm² armored cable DC bipole"
)
