function build_case(::Val{:cable_525kv_land_no_armour_ac_flat}, p)
...
case_definition(Base.Fix1(build_case, Val(:cable_525kv_land_no_armour_ac_flat)),
    ...
    description = "525 kV unarmoured land cables in AC flat formation"
)
