function build_case(::Val{:cable_320kv_armoured_dc_bipole}, p)
...
case_definition(Base.Fix1(build_case, Val(:cable_320kv_armoured_dc_bipole)),
    ...
    description = "320 kV armoured cable DC bipole"
)
