function build_case(::Val{:cable_132kv_630mm2_flathor}, p)
...
case_definition(Base.Fix1(build_case, Val(:cable_132kv_630mm2_flathor)),
    ...
    (
        ...
        insulation_thickness = case_parameter(
            :insulation_thickness, 16.0e-3; tags = (:geometry, :cable_layer, :length)
        ),
