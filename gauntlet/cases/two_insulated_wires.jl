function build_case(::Val{:two_insulated_wires}, p)
...
case_definition(Base.Fix1(build_case, Val(:two_insulated_wires)),
    :two_insulated_wires,
    (
    ...
    description = "Two buried wires with 1 mm insulation"
)
