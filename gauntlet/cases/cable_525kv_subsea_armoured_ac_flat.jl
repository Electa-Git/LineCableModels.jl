function build_case(::Val{:cable_525kv_subsea_armoured_ac_flat}, p)
...
case_definition(Base.Fix1(build_case, Val(:cable_525kv_subsea_armoured_ac_flat)),
    ...
    description = "525 kV armoured subsea cables in AC flat formation"
)
