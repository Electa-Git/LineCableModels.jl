...
function PartSpec(component::Symbol, part_type::Type, n_layers::Int;
...
function CableBuilder(id::AbstractString, parts::Vector{PartSpec}; nominal = nothing)
...
function Solid(component::Symbol; d, m)
...
function Semicon(component::Symbol; layers::Int, t, m)
