...
function _serializable_fields(::NominalData)
    (
        :designation_code,
        :U0,
        :U,
...
function _serializable_fields(::CircStrands)
    (
...
# Layer Types (Conductor Parts)
function _serializable_fields(::RectStrands)
    (
        :r_in, # Needed for first layer reconstruction
        :thickness,
        :width,
...
function _serializable_fields(::Strip)
    (
        :r_in, # Needed for first layer reconstruction
        :r_ex,
        :width,
