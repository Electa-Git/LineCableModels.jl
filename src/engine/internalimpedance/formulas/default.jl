...
function (formula::Formula{:default})(
    ...
    state = surface_impedance_state(
        Val(:default), r_in, r_ex, rho_c, mur_c, jω
    )
    return Functor{:default, typeof(formula.binding), typeof(formula.hooks),
...
computation_options(::FormulaMethod{:default, typeof(internal_impedance)}) = (;)
