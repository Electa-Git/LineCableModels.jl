...
The mutual specialization replaces ``r_i`` by the horizontal pair
separation.
...
Remote Sensing*, 30, 140–146, 1992; the implemented radial approximation is
the Bridges form reproduced in Ametani et al., IET, 2021.
"""
