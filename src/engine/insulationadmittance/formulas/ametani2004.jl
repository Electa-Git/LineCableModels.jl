...
function description(::Type{<:Formula{:Ametani2004}}; compact::Bool=false)
    compact ? "Ametani2004" : "Ametani complex-permittivity dielectric admittance model (2004)"
end
...
computation_options(::FormulaMethod{:Ametani2004, typeof(insulation_material)}) = (;)
