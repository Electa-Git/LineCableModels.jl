...
UIContainerSpec(name, parent, at; layout = (;)) = UIContainerSpec(name, parent, at, layout)
...
function UISlotSpec(name, parent, at; layout = (;), attrs = (;))
...
# Constructor
UIButtonSpec(label, icon, action; attrs = (;)) = UIButtonSpec(label, icon, action, attrs)
...
# Constructor
function UIToggleSpec(label, active, action; attrs = (;))
