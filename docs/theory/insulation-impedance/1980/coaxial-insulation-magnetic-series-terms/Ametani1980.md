...
The magnetic annulus coefficient uses the physical insulation radii and permeability. A logarithm of one plus the relative thickness preserves thin-layer accuracy. Each radial term enters the loop-to-terminal matrix transformation; no earth correction or dielectric shunt contribution is included in this series coefficient.
