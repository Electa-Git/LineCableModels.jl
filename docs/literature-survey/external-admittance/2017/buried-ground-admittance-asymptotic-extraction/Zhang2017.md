...
Equations (A.9)–(A.12) evaluate the tail through generalized exponential integrals ``\operatorname{Ei}(n,z)``. A direct numerical tail integral of (A.6)–(A.7) is mathematically equivalent when the special function is unavailable.
