...
**Limitations.** Circular finite pipe and enclosed cores; mode formulas assume the symmetrical three-core arrangement. Publisher-version equality remains unverified; The printed (31) grouping, limit notation and external ``Z_g(0)`` input remain unresolved; none is repaired. General unequal-core proximity is not covered by these pipe terms.
