...
subtitle: "An application identity and navigation surface that contracts to a meaningful icon rail. Copy this template with its component CSS and JavaScript, plus the shared brand.css and control-contract.css."
  ...
  <aside class="lc-cs-sidebar" aria-label="Example application navigation">
    ...
    <nav class="lc-cs-navigation" id="lc-cs-demo-navigation">
      <section class="lc-cs-nav-section" aria-labelledby="lc-cs-section-workspace">
        ...
        <button class="lc-cs-nav-item" type="button" data-demo-title="Cable geometry" data-tooltip="Cable geometry" aria-label="Cable geometry">
          <svg class="lc-cs-nav-icon" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
        ...
        <button class="lc-cs-nav-item" type="button" data-demo-title="Line parameters" data-tooltip="Line parameters" aria-label="Line parameters" aria-current="page">
          <svg class="lc-cs-nav-icon" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
            <path d="M4 7h10"></path>
            <path d="M18 7h2"></path>
    ...
    <div class="lc-cs-canvas" role="region" aria-label="Example content canvas">
      ...
      <div class="lc-cs-analysis-layout">
        ...
        <aside class="lc-cs-state-panel" aria-label="Demonstrated states">
          ...
          <dl>
            <div><dt>Normal</dt><dd>Unselected item, pointer away</dd></div>
            <div><dt>Hovered</dt><dd>Move the pointer over an enabled item</dd></div>
            <div><dt>Active</dt><dd>Click an item to select it</dd></div>
            <div><dt>Focused</dt><dd>Tab to an item for its keyboard outline</dd></div>
