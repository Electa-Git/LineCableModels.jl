...
| 6. Generic UI | One `JobPanel` owns Run/Cancel/Retry, dirty state, progress, console, cache status, retained result, and a persistent result callback. | `src/widgets/JobControls.jl`, `src/broker/JobHandle.jl`, `test/jobhandle.jl`. |
